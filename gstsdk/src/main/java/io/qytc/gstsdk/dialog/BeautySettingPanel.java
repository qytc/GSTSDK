...
//    TXHorizontalPickerView mSecondGradlePicker;
    ...
    public BeautySettingPanel(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                    Utils.hasGingerbread() ? new LinkedBlockingDeque<Runnable>() : new LinkedBlockingQueue<Runnable>(),
    ...
    private class CustomProgressDialog {
        ...
        public void createLoadingDialog(Context context, String msg) {
            ...
            LinearLayout layout = v.findViewById(R.id.layout_progress);// 加载布局

            ImageView spaceshipImage = v.findViewById(R.id.progress_img);
            tvMsg = v.findViewById(R.id.msg_tv);
            // 加载动画
